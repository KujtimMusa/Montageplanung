  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block size-4 translate-x-0.5 rounded-full bg-background shadow-lg ring-0 transition-transform data-checked:translate-x-[calc(100%-2px)] data-checked:bg-primary-foreground"
        )}
      />
    </SwitchPrimitive.Root>
  );
